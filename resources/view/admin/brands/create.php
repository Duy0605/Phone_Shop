...
<head>
    ...
    <title><?= $pageTitle ?? 'Thêm thương hiệu' ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        <h1>➕ Thêm thương hiệu - Phone Shop</h1>
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <form method="POST" action="<?= config('app.base_url') ?>/admin/brands/create"
                enctype="multipart/form-data">
                <div class="form-group">
                    <label>
                        Tên thương hiệu <span class="required">*</span>
                    </label>
                    <input type="text" name="name" placeholder="VD: Apple, Samsung, Xiaomi..." required autofocus>
                    <small>Nhập tên thương hiệu chính xác</small>
                </div>

                <div class="form-group">
                    <label>Mô tả thương hiệu</label>
                    <textarea name="description" placeholder="Giới thiệu ngắn gọn về thương hiệu..."></textarea>
                ...
                <div class="form-group">
                    ...
                    <small>Chọn file logo (JPG, PNG) - Tối đa 2MB. Nên dùng ảnh nền trắng/trong suốt</small>
