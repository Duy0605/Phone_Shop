...
<head>
    ...
    <title><?= $pageTitle ?? 'Thêm sản phẩm mới' ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        <h1>➕ Thêm sản phẩm mới - Phone Shop</h1>
        ...
        <div class="section">
            ...
            <form method="POST" action="<?= config('app.base_url') ?>/admin/products/create"
                ...
                <div class="form-group">
                    ...
                    <textarea name="specs"
                        placeholder="VD:&#10;- Màn hình: 6.7 inch Super Retina XDR&#10;- Chip: A17 Pro&#10;- RAM: 8GB&#10;- Bộ nhớ: 256GB&#10;- Camera: 48MP + 12MP + 12MP"></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" min="0" step="1000" placeholder="29990000" required>
                ...
                <div class="form-group">
                    ...
                    <small>Chọn file ảnh (JPG, PNG, GIF) - Tối đa 2MB</small>
